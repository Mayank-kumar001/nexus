    ...
    <div className="mx-auto max-w-4xl">
      ...
      <dl className="mb-8 grid gap-4 rounded-4xl border bg-card p-6 sm:grid-cols-2">
        ...
        <div>
          ...
          <dd className="mt-1 text-sm">{format(new Date(record.achievedOn), "d MMMM yyyy")}</dd>
        </div>
        ...
        {record.reviewedAt ? (
          <div className="sm:col-span-3">
            <dt className="text-xs uppercase tracking-[0.16em] text-muted-foreground">Reviewed on</dt>
            <dd className="mt-1 text-sm">
              {format(new Date(record.reviewedAt), "d MMM yyyy HH:mm")}
            </dd>
          </div>
        ) : null}
      </dl>
